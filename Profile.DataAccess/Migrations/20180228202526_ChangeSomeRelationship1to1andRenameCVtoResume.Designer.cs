...
namespace Profile.DataAccess.Migrations
{
    ...
    [Migration("20180228202526_ChangeSomeRelationship1to1andRenameCVtoResume")]
    partial class ChangeSomeRelationship1to1andRenameCVtoResume
    {
            ...
            modelBuilder.Entity("Profile.Model.Models.ContactInfo", b =>
                {
                    b.HasOne("Profile.Model.Models.Resume", "Resume")
                        .WithOne("ContactInfo")
                        .HasForeignKey("Profile.Model.Models.ContactInfo", "ResumeId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
