...
(function ($) {
    ...
    var bs = {
        3: {
            ...
            pullClass: 'pull',
            toobarDropdowHtml: ['<ul class="dropdown-menu table__button_dropdown" role="menu">', '</ul>'],
            toobarDropdowItemHtml: '<li role="menuitem"><label>%s</label></li>',
            pageDropdownHtml: ['<ul class="dropdown-menu table__button_dropdown" role="menu">', '</ul>'],
        ...
        4: {
            ...
            pullClass: 'float',
            toobarDropdowHtml: ['<div class="dropdown-menu table__button_dropdown">', '</div>'],
            toobarDropdowItemHtml: '<label class="dropdown-item">%s</label>',
            pageDropdownHtml: ['<div class="dropdown-menu table__button_dropdown">', '</div>'],
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showColumns) {
            html.push(sprintf('<div class="keep-open btn-group" title="%s">',
                ...
                sprintf(' btn-primary table__checkbox_button', this.options.buttonsClass) +
                sprintf(' btn-%s', this.options.iconSize) +
                ' dropdown-toggle" data-toggle="dropdown">',
                sprintf('Show columns', this.options.iconsPrefix, this.options.icons.columns),
            ...
            $.each(this.columns, function (i, column) {
                ...
                if (column.switchable) {
                    html.push(sprintf(bs.toobarDropdowItemHtml,
                        sprintf('<input type="checkbox" class="table__button_list" data-field="%s" value="%s"%s> %s',
